"""PhysioNet EEGBCI loading: cache path, download, montage, and filtering helpers."""
...
# src/bci/eegbci.py → repo root is three levels up
_PROJECT_ROOT = Path(__file__).resolve().parent.parent.parent
MNE_DATA_DIR = str(_PROJECT_ROOT / "mne_data")
